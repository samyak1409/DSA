...
def isPowerOfThree(n: int) -> bool:
    ...
    #                                       case 2.1) value from 'log' is a decimal num: 'round' will convert it to int, reverse check will return False
    ...
    # https://leetcode.com/problems/power-of-three/solution/#:~:text=Approach%204%3A%20Integer%20Limitations
