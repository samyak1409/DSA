...
def reverse_list(head: Optional[ListNode]) -> Optional[ListNode]:
    ...
    def reverse(curr, prev=None):
        ...
        next_curr = curr.nxt  # save ref to the next of curr node for updating in the end
        curr.nxt = prev  # reverse the pointer direction from next to prev node
    ...
    while head:  # iterate till the end
        ...
        next_head = head.nxt  # save ref to the next of curr node (`head`) for updating in the end
        head.nxt = prev  # reverse the pointer direction from next to prev node
